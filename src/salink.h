...
#define SALINK_LABEL_TYPE_EQU_GLOBAL_SHORT 6
#define SALINK_LABEL_TYPE_EQU_GLOBAL_LONG 7
#define SALINK_LABEL_TYPE_EQU_EVAL_SHORT 8
#define SALINK_LABEL_TYPE_EQU_EVAL_LONG 9
#define SALINK_LABEL_TYPE_EQU_EVAL_GLOBAL_SHORT 10
#define SALINK_LABEL_TYPE_EQU_EVAL_GLOBAL_LONG 11
