...
#define SBC_ERROR_ENDWHILE_UNEXPECTED (SPECASM_MAX_ERRORS + 17)
#define SBC_ERROR_LINENO_EXPECTED (SPECASM_MAX_ERRORS + 18)
#define SBC_ERROR_COMMA_EXPECTED (SPECASM_MAX_ERRORS + 19)
#define SBC_ERROR_TO_EXPECTED (SPECASM_MAX_ERRORS + 20)
#define SBC_ERROR_NEXT_UNEXPECTED (SPECASM_MAX_ERRORS + 21)
#define SBC_ERROR_CLOSEB_EXPECTED (SPECASM_MAX_ERRORS + 22)
#define SBC_ERROR_OF_EXPECTED (SPECASM_MAX_ERRORS + 23)
#define SBC_ERROR_ENDCASE_UNEXPECTED (SPECASM_MAX_ERRORS + 24)
#define SBC_ERROR_OPENB_EXPECTED (SPECASM_MAX_ERRORS + 25)
#define SBC_ERROR_PROC_OR_FN_EXPECTED (SPECASM_MAX_ERRORS + 26)
#define SBC_ERROR_ELSE_OR_ENDIF_UNEXPECTED (SPECASM_MAX_ERRORS + 27)
#define SBC_ERROR_ENDPROC_UNEXPECTED (SPECASM_MAX_ERRORS + 28)
#define SBC_ERROR_MAX (SPECASM_MAX_ERRORS + 29)
